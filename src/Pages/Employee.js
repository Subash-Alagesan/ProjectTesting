...
import assignment from '../Component/Images/assignment_ind.png'
import business from '../Component/Images/business_center.png';
import contact from '../Component/Images/contact_page.png'
import badge from '../Component/Images/badge.png'
import personaddd from '../Component/Images/person_add.png'
...
function Customer() {
  ...
  return (
    ...
    <>
      ...
      <Grid container spacing={3} className='Employeedb-fullcontainer' >

        <Grid item xs={3.5} sm={3.5} md={12} lg={12} className='Employeedb-topsection' style={{ background: "#ffffff", marginLeft: "20px", marginRight: "20px" }} >
          <div style={{ display: "flex", paddingLeft: "10px" }} >
            <div><img src={business} alt='' className='customerdb-container-business-img' /></div>
            <div> <h5 className='Employeedb-heading'>Employee Database</h5></div>

          </div>

          <Grid container spacing={1} style={{ paddingLeft: "10px", paddingRight: "30px", paddingTop: "20px" }}>
            <Grid item xs={12} sm={12} md={3} lg={3}>
              <Item>
                <div className='Emptotal-item1'>
        ...
        <Grid container spacing={0} className='Emptable-fullcontainer'>
          <Grid item xs={3.6} sm={3.6} md={12} lg={12} className='Emptable-content'>
            <Item>
              <div style={{ display: "flex", paddingTop: "10px" }} >
                <div><h4 className='All-Employees'>All employees</h4></div>
                <div className='EmpSearch-content' >
                  <Search className='EmpSearch-bar' >
                    <SearchIconWrapper>
                      <SearchIcon />
                    </SearchIconWrapper>
                    <StyledInputBase
                ...
                <FormControl sx={{ m: 1, minWidth: 150 }} size="small" style={{
              ...
              <div className='EmpDatagrid-table'>
                <DataGrid
                  rows={rows}
                  columns={columns}
