...
function Customer() {
  ...
  return (
    ...
    <>
      ...
      <Grid container spacing={3}  className='customerdb-fullcontainer' >

        <Grid item xs={3.5} sm={3.5} md={12} lg={12} className='customerdb-topsection' style={{background:"#ffffff",marginLeft:"20px",marginRight:"20px"}} >
        ...
        <Grid container spacing={0}  className='table-fullcontainer'>
          <Grid item xs={3.6} sm={3.6} md={12} lg={12} className='table-content'>
            <Item>
