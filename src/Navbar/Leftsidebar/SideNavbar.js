  ...
  const SideNavbar = () => {
    ...
    const handleAddCustomerClick = () => {
      ...
      // You can also add any other logic you need when the button is clicked.
    };
  ...
  <h4 className="admin1"> Admin Panel</h4>
          ...
          <Grid item xs={12} sm={12} md={8} lg={8} style={{ maxHeight: '50%' }}>
            {clickedButton}
            {/* {isContentDisabled ? <Businessprofile /> : clickedButton} */}
          </Grid>
